...
import application.model.dto.ChartDTO;
...
@SqlResultSetMappings( // ánh xạ kết quả của một truy vấn SQL vào lớp đối tượng chartBrandDTO Java
        value = {
                @SqlResultSetMapping(
                        name = "chartBrandDTO",
...
@NamedNativeQuery( // mô tả truy vấn
